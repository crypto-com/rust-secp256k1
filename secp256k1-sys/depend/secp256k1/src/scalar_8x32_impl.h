...
SECP256K1_INLINE static int rustsecp256k1_v0_1_2_scalar_reduce(rustsecp256k1_v0_1_2_scalar *r, uint32_t overflow) {
    uint64_t t;
...
static void rustsecp256k1_v0_1_2_scalar_negate(rustsecp256k1_v0_1_2_scalar *r, const rustsecp256k1_v0_1_2_scalar *a) {
    uint32_t nonzero = 0xFFFFFFFFUL * (rustsecp256k1_v0_1_2_scalar_is_zero(a) == 0);
...
static int rustsecp256k1_v0_1_2_scalar_cond_negate(rustsecp256k1_v0_1_2_scalar *r, int flag) {
    ...
    uint32_t nonzero = 0xFFFFFFFFUL * (rustsecp256k1_v0_1_2_scalar_is_zero(r) == 0);
...
static void rustsecp256k1_v0_1_2_scalar_reduce_512(rustsecp256k1_v0_1_2_scalar *r, const uint32_t *l) {
    uint64_t c;
...
static void rustsecp256k1_v0_1_2_scalar_mul_512(uint32_t *l, const rustsecp256k1_v0_1_2_scalar *a, const rustsecp256k1_v0_1_2_scalar *b) {
    /* 96 bit accumulator. */
...
static void rustsecp256k1_v0_1_2_scalar_sqr_512(uint32_t *l, const rustsecp256k1_v0_1_2_scalar *a) {
    /* 96 bit accumulator. */
    uint32_t c0 = 0, c1 = 0, c2 = 0;
...
SECP256K1_INLINE static void rustsecp256k1_v0_1_2_scalar_mul_shift_var(rustsecp256k1_v0_1_2_scalar *r, const rustsecp256k1_v0_1_2_scalar *a, const rustsecp256k1_v0_1_2_scalar *b, unsigned int shift) {
    ...
    rustsecp256k1_v0_1_2_scalar_cadd_bit(r, 0, (l[(shift - 1) >> 5] >> ((shift - 1) & 0x1f)) & 1);
}
