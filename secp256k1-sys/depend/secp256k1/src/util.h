...
typedef struct {
    ...
    const void* data;
} rustsecp256k1_v0_1_2_callback;

static SECP256K1_INLINE void rustsecp256k1_v0_1_2_callback_call(const rustsecp256k1_v0_1_2_callback * const cb, const char * const text) {
