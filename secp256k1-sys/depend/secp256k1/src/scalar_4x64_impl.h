...
SECP256K1_INLINE static void rustsecp256k1_v0_1_2_scalar_clear(rustsecp256k1_v0_1_2_scalar *r) {
    r->d[0] = 0;
    r->d[1] = 0;
    r->d[2] = 0;
    r->d[3] = 0;
...
SECP256K1_INLINE static void rustsecp256k1_v0_1_2_scalar_set_int(rustsecp256k1_v0_1_2_scalar *r, unsigned int v) {
    r->d[0] = v;
    r->d[1] = 0;
    r->d[2] = 0;
    r->d[3] = 0;
...
SECP256K1_INLINE static int rustsecp256k1_v0_1_2_scalar_check_overflow(const rustsecp256k1_v0_1_2_scalar *a) {
    int yes = 0;
    int no = 0;
...
SECP256K1_INLINE static int rustsecp256k1_v0_1_2_scalar_reduce(rustsecp256k1_v0_1_2_scalar *r, unsigned int overflow) {
    uint128_t t;
...
static int rustsecp256k1_v0_1_2_scalar_add(rustsecp256k1_v0_1_2_scalar *r, const rustsecp256k1_v0_1_2_scalar *a, const rustsecp256k1_v0_1_2_scalar *b) {
    ...
    overflow = t + rustsecp256k1_v0_1_2_scalar_check_overflow(r);
    VERIFY_CHECK(overflow == 0 || overflow == 1);
    rustsecp256k1_v0_1_2_scalar_reduce(r, overflow);
    return overflow;
}
...
static void rustsecp256k1_v0_1_2_scalar_set_b32(rustsecp256k1_v0_1_2_scalar *r, const unsigned char *b32, int *overflow) {
    ...
    over = rustsecp256k1_v0_1_2_scalar_reduce(r, rustsecp256k1_v0_1_2_scalar_check_overflow(r));
    if (overflow) {
        *overflow = over;
    }
}
...
static void rustsecp256k1_v0_1_2_scalar_negate(rustsecp256k1_v0_1_2_scalar *r, const rustsecp256k1_v0_1_2_scalar *a) {
    uint64_t nonzero = 0xFFFFFFFFFFFFFFFFULL * (rustsecp256k1_v0_1_2_scalar_is_zero(a) == 0);
...
static int rustsecp256k1_v0_1_2_scalar_cond_negate(rustsecp256k1_v0_1_2_scalar *r, int flag) {
     ...
     * if we are flag = 1, mask = 11...11 and this is identical to rustsecp256k1_v0_1_2_scalar_negate */
    uint64_t mask = !flag - 1;
    uint64_t nonzero = (rustsecp256k1_v0_1_2_scalar_is_zero(r) != 0) - 1;
...
static void rustsecp256k1_v0_1_2_scalar_reduce_512(rustsecp256k1_v0_1_2_scalar *r, const uint64_t *l) {
    ...
    rustsecp256k1_v0_1_2_scalar_reduce(r, c + rustsecp256k1_v0_1_2_scalar_check_overflow(r));
}

static void rustsecp256k1_v0_1_2_scalar_mul_512(uint64_t l[8], const rustsecp256k1_v0_1_2_scalar *a, const rustsecp256k1_v0_1_2_scalar *b) {
#ifdef USE_ASM_X86_64
...
static void rustsecp256k1_v0_1_2_scalar_sqr_512(uint64_t l[8], const rustsecp256k1_v0_1_2_scalar *a) {
#ifdef USE_ASM_X86_64
    __asm__ __volatile__(
    /* Preload */
    "movq 0(%%rdi), %%r11\n"
...
static void rustsecp256k1_v0_1_2_scalar_mul(rustsecp256k1_v0_1_2_scalar *r, const rustsecp256k1_v0_1_2_scalar *a, const rustsecp256k1_v0_1_2_scalar *b) {
    uint64_t l[8];
    rustsecp256k1_v0_1_2_scalar_mul_512(l, a, b);
    rustsecp256k1_v0_1_2_scalar_reduce_512(r, l);
}
...
static void rustsecp256k1_v0_1_2_scalar_sqr(rustsecp256k1_v0_1_2_scalar *r, const rustsecp256k1_v0_1_2_scalar *a) {
    uint64_t l[8];
    rustsecp256k1_v0_1_2_scalar_sqr_512(l, a);
    rustsecp256k1_v0_1_2_scalar_reduce_512(r, l);
}
...
SECP256K1_INLINE static void rustsecp256k1_v0_1_2_scalar_mul_shift_var(rustsecp256k1_v0_1_2_scalar *r, const rustsecp256k1_v0_1_2_scalar *a, const rustsecp256k1_v0_1_2_scalar *b, unsigned int shift) {
    uint64_t l[8];
    ...
    rustsecp256k1_v0_1_2_scalar_cadd_bit(r, 0, (l[(shift - 1) >> 6] >> ((shift - 1) & 0x3f)) & 1);
}
