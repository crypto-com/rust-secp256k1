 ...
 *  comparison, use rustsecp256k1_v0_1_2_xonly_pubkey_serialize and
 *  rustsecp256k1_v0_1_2_xonly_pubkey_parse.
 */
typedef struct {
    unsigned char data[64];
} rustsecp256k1_v0_1_2_xonly_pubkey;
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1_v0_1_2_xonly_pubkey_parse(
    const rustsecp256k1_v0_1_2_context* ctx,
    rustsecp256k1_v0_1_2_xonly_pubkey* pubkey,
 ...
 *                 (cannot be NULL).
 *  In:    pubkey: a pointer to a rustsecp256k1_v0_1_2_xonly_pubkey containing an
 *                 initialized public key (cannot be NULL).
 */
SECP256K1_API int rustsecp256k1_v0_1_2_xonly_pubkey_serialize(
    const rustsecp256k1_v0_1_2_context* ctx,
    unsigned char *output32,
    const rustsecp256k1_v0_1_2_xonly_pubkey* pubkey
) SECP256K1_ARG_NONNULL(1) SECP256K1_ARG_NONNULL(2) SECP256K1_ARG_NONNULL(3);

/** Converts a rustsecp256k1_v0_1_2_pubkey into a rustsecp256k1_v0_1_2_xonly_pubkey.
 *
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1_v0_1_2_xonly_pubkey_from_pubkey(
    const rustsecp256k1_v0_1_2_context* ctx,
    rustsecp256k1_v0_1_2_xonly_pubkey *xonly_pubkey,
    int *pk_parity,
    const rustsecp256k1_v0_1_2_pubkey *pubkey
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1_v0_1_2_xonly_pubkey_tweak_add(
    const rustsecp256k1_v0_1_2_context* ctx,
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1_v0_1_2_keypair_create(
    const rustsecp256k1_v0_1_2_context* ctx,
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1_v0_1_2_keypair_pub(
    const rustsecp256k1_v0_1_2_context* ctx,
    rustsecp256k1_v0_1_2_pubkey *pubkey,
    const rustsecp256k1_v0_1_2_keypair *keypair
) SECP256K1_ARG_NONNULL(1) SECP256K1_ARG_NONNULL(2) SECP256K1_ARG_NONNULL(3);

/** Get the x-only public key from a keypair.
 *
 *  This is the same as calling rustsecp256k1_v0_1_2_keypair_pub and then
 *  rustsecp256k1_v0_1_2_xonly_pubkey_from_pubkey.
 *
 *  Returns: 0 if the arguments are invalid. 1 otherwise.
 *  Args:   ctx: pointer to a context object (cannot be NULL)
 ...
 *               argument of rustsecp256k1_v0_1_2_xonly_pubkey_from_pubkey (can be NULL).
 *  In: keypair: pointer to a keypair (cannot be NULL)
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1_v0_1_2_keypair_xonly_pub(
    const rustsecp256k1_v0_1_2_context* ctx,
    rustsecp256k1_v0_1_2_xonly_pubkey *pubkey,
    int *pk_parity,
    const rustsecp256k1_v0_1_2_keypair *keypair
 ...
 *
 *  Calling this function and then rustsecp256k1_v0_1_2_keypair_pub results in the same
 *  public key as calling rustsecp256k1_v0_1_2_keypair_xonly_pub and then
 *  rustsecp256k1_v0_1_2_xonly_pubkey_tweak_add.
 *
 ...
 *                   to rustsecp256k1_v0_1_2_ec_seckey_verify, this function returns 0. For
 *                   uniformly random 32-byte arrays the chance of being invalid
 *                   is negligible (around 1 in 2^128) (cannot be NULL).
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1_v0_1_2_keypair_xonly_tweak_add(
    const rustsecp256k1_v0_1_2_context* ctx,
    rustsecp256k1_v0_1_2_keypair *keypair,
    const unsigned char *tweak32
) SECP256K1_ARG_NONNULL(1) SECP256K1_ARG_NONNULL(2) SECP256K1_ARG_NONNULL(3);
